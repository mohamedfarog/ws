...
static const _AckermannFeedback_type_support_symbol_names_t _AckermannFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ackermann_interfaces, msg, AckermannFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ackermann_interfaces, msg, AckermannFeedback)),
  }
};
...
{
  return &::ackermann_interfaces::msg::rosidl_typesupport_cpp::AckermannFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ackermann_interfaces, msg, AckermannFeedback)() {
  return get_message_type_support_handle<ackermann_interfaces::msg::AckermannFeedback>();
}
